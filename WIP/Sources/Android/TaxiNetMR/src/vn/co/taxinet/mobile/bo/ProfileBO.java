...
//		if (!rider.getEmail().equalsIgnoreCase(email)
//				|| !rider.getPassword().equalsIgnoreCase(password)
//				|| !rider.getFirstName().equalsIgnoreCase(firstName)
//				|| !rider.getLastName().equalsIgnoreCase(lastName)
//				|| !rider.getPhoneNumber().equalsIgnoreCase(phone)) {
