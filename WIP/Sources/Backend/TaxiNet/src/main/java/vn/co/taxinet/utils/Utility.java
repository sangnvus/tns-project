...
public final class Utility {
    ...
    /**
     * Keep reference to the only ServletContext instance of TaxiNet application (per JVM).
     */
     ...
     *
     * @param sc the ServletContext instance of CAP in this JVM
     */
...
//        UserProfile profile = (UserProfile) request.getSession().getAttribute(UserProfile.SESSION_PROFILE);
...
//    }
     ...
     * @throws FunctionalException
     */
    public static Date stringToDate(String stringDate, String format) throws FunctionalException {
        final String LOCATION = THIS + "stringToDate(" + stringDate + ", " + format + ")";
        ...
        try {
            ...
            throw new FunctionalException(LOCATION,
                    "Cannot parse string " + stringDate + " to Date!",
                    Constants.Errors.PARSE_DATE_ERROR, new Object[] {stringDate});
        }
    }
     ...
     * @throws FunctionalException
     */
    public static Date formatDate(Date date, String format) throws FunctionalException {
        ...
        try {
            ...
            throw new FunctionalException(LOCATION,
                    "Cannot parse string " + date + "to Date!",
                    Constants.Errors.PARSE_DATE_ERROR, new Object[] {date});
        }
    }
     ...
     *
     * @param stringDate date value in String format
     * @param pattern    Date pattern used to convert
     * @return java.sql.Date
     */
    public static java.sql.Date stringToSQLDate(String stringDate, String pattern) throws FunctionalException {
        final String LOCATION = THIS + "stringToSQLDate(" + stringDate + ", " + pattern + ")";
        ...
        try {
            ...
            throw new FunctionalException(LOCATION,
                    "Cannot parse string " + stringDate + " to SQL Date!",
                    Constants.Errors.PARSE_DATE_ERROR, new Object[] {stringDate});
        }
    }
     ...
     * @throws FunctionalException
     */
    public static Timestamp stringToTimestamp(String dateString, String formatDate) throws FunctionalException {
        final String LOCATION = THIS + "stringToTimestamp(" + dateString + ", " + formatDate + ")";
        ...
        try {
            ...
            throw new FunctionalException(LOCATION,
                    "Cannot parse string " + dateString + " to Timestamp!",
                    Constants.Errors.PARSE_DATE_ERROR, new Object[] {dateString});
        }
    }
    ...
    public static String dateToString(Date date) {
        ...
        SimpleDateFormat fm = new SimpleDateFormat(Constants.STR_DATE_TIME_FORMAT);
     ...
     *
     * @param basename the name of application resource
     */
    public static void setupOnlineResource(String basename, ServletContext servletContext) {
        if (onlineResource == null) {
           // onlineResource = XMLResourceBundle.getBundle(basename, new Locale("", ""), servletContext);
        }
    }
    ...
    public static boolean isDate(String strDateValue) {
        if (strDateValue == null || strDateValue.trim().length() == 0 || strDateValue.trim().length() != 10) {
            return false;
        }
        try {
            SimpleDateFormat fm = new SimpleDateFormat(Constants.STR_DATE_FORMAT);
            fm.setLenient(false);
     ...
     * @throws FunctionalException
     */
    public static double stringToDouble(String strNumber) throws FunctionalException {
        ...
        try {
            ...
            throw new FunctionalException(LOCATION,
                    "Cannot parse string " + strNumber + "to double!",
                    Constants.Errors.PARSE_NUMBER_ERROR, new Object[] {strNumber});
        }
    }
    /**
     * @param strNumber
     ...
     * @throws FunctionalException
     */
    public static float stringToFloat(String strNumber, String applyPattern) throws FunctionalException {
        final String LOCATION = THIS + "stringToDouble(" + strNumber + ")";
        if (strNumber == null || strNumber.length() == 0) {
            return 0.00000f;
        }
        try {
            ...
            throw new FunctionalException(LOCATION,
                    "Cannot parse string " + strNumber + "to float!",
                    Constants.Errors.PARSE_NUMBER_ERROR, new Object[] {strNumber});
        }
    }
    /**
    ...
    public static boolean isMoney(double money) {
        try {
            if (money >= 0 && money <= Constants.MAX_VAL_MONEY /*|| money == Constants.BLANK_MONEY*/) {
                return true;
            }
            return false;
        } catch (Exception e) {
...
//        UserProfile profile = (UserProfile) request.getSession().getAttribute(UserProfile.SESSION_PROFILE);
//        return profile.getAttribute(UserProfile.USER_ID) == null ? 0 : Long.parseLong(profile.getAttribute(UserProfile.USER_ID));
//    }
...
//    }
    ...
    public static ResourceBundle getResourceBundle(Locale userLocale) {
        return null;// XMLResourceBundle.getBundle(Constants.INTER_SUPPORT_CAP, userLocale, servletContext);
    }
...
//    }
     ...
     */
//    public static LocalizationContext getLocalizationContext(HttpServletRequest request) {
//        return (LocalizationContext) request.getSession().getAttribute(Config.FMT_LOCALIZATION_CONTEXT);
//    }
     ...
     * @return
     */
//    public static String getI18nMessage(String key, HttpServletRequest request) {
...
//    }
     ...
     * @return
     */
//    public static String getI18nMessage(String key, HttpServletRequest request, Object[] values) {
//        String message = null;
//        try {
//            message = getResourceBundle(request).getString(key);
//            message = MessageFormat.format(message, values == null ? new Object[0] : values);
//        } catch (Exception e) {
//            message = "???";
//            logger.warn(e);
//        }
...
//
     ...
     * @return
     */
    public static String getI18nMessage(String key, Locale userLocale, Object[] values) {
        String message = null;
        try {
...
//        try {
//            NumberFormat formatter = new DecimalFormat(Constants.STR_VT_DIVIDER_FORMAT);
//            String s = number == 0 ? "0.00000" : formatter.format(formatFloat(number, 5));
//            return s;
//        } catch (Exception e) {
...
//            String s = number == 0 ? "0.00" : formatter.format(formatDouble(number, 2));
//            return s;
//        } catch (Exception e) {
//            throw new SystemException(LOCATION, e.getMessage());
//        }
//    }
     ...
     * @throws SystemException
     */
//    public static String formatCurrency(double number, String format) throws SystemException {
//        final String LOCATION = THIS + "formatCurrency(" + number + ")";
//        try {
...
//    }
     ...
     * @throws SystemException
     */
//    public static String formatCurrency(double number, int digit) throws SystemException {
//        final String LOCATION = THIS + "formatCurrency(" + number + ", " + digit + ")";
//        try {
//            switch (digit) {
//                case 0: {
//                    NumberFormat formatter = new DecimalFormat(Constants.STR_MONEY_FORMAT_ZERO);
//                    String s = number == 0 ? "0" : formatter.format(formatDouble(number, 0));
//                    return s;
//                }
//                case 1: {
//                    NumberFormat formatter = new DecimalFormat(Constants.STR_MONEY_FORMAT_ONE);
//                    String s = number == 0 ? "0.0" : formatter.format(formatDouble(number, 1));
//                    return s;
//                }
//                case 3: {
//                    NumberFormat formatter = new DecimalFormat(Constants.STR_MONEY_FORMAT_THRID);
//                    String s = number == 0 ? "0.000" : formatter.format(formatDouble(number, 3));
//                    return s;
//                }
//                default : {
//                    NumberFormat formatter = new DecimalFormat(Constants.STR_MONEY_FORMAT);
...
//                strResult = number == 0 ? "0" : formatter.format(formatDouble(number, 0));
//            } else {
//                StringBuffer suffix = new StringBuffer(".");
//                for (int i = 0; i < digit; i++) {
//                    suffix.append("0");
//                }
//                NumberFormat formatter = new DecimalFormat(Constants.STR_DECIMAL_FORMAT + suffix.toString());
//                strResult = number == 0 ? ("0" + suffix.toString()) : formatter.format(formatDouble(number, digit));
//            }
//            return strResult;
//        } catch (Exception e) {
//            return "";
...
//    }
    ...
    public static void printObjectAttributesToScreen(Object object) {
        ...
        for (int i = 0; i < fields.length; i++) {
            try {
                Field field = fields[(i)];
                field.setAccessible(true);
                System.err.println("    " + field.getName() + " = " + field.get(object));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
     ...
     * @throws FunctionalException
     */
    public static void writeToFile(String filePath, StringBuffer buffer) throws FunctionalException {
        ...
        try {
            ...
            throw new FunctionalException(LOCATION, Constants.Errors.INVALID_PATH);
        } catch (IOException ioEx) {
            logger.error(ioEx.getMessage());
            throw new FunctionalException(LOCATION, Constants.Errors.WRITTING_FILE_ERROR);
        }
     ...
     * @param day  the number of days (offset day) calculated from Monday
     * @return
     */
    ...
    /**
     * @param money
     * @param degit after "." symbol
     * @return true if money's format is correct, false if money's format is wrong
     * @author kientnt1
     * check format of money
     */
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (k < count) {
                        ...
                        if (dotIndex > 0) {
                            ...
                            if (subStr1.length() > 3 || !Utility.isDouble(subStr1)) {
                                return false;
                            }
                            subStr2 = str.substring(dotIndex + 1);
                            if (subStr2.length() > degit || !Utility.isDouble(subStr2)) {
                                return false;
                            }
                        } else {
     ...
     * @throws FunctionalException
     */
    public static long daysBetween(Date beforeDate, Date afterDate) throws FunctionalException {
        beforeDate = removeTime(beforeDate);
        afterDate = removeTime(afterDate);

        long diffMillis = (beforeDate.getTime() - afterDate.getTime()) / (24 * 60 * 60 * 1000);
        return diffMillis;
    }
    
    public static long daysBetween1(Date fromDate, Date toDate) throws FunctionalException {
        fromDate = removeTime(fromDate);
        toDate = removeTime(toDate);

        long diffMillis = (toDate.getTime() - fromDate.getTime()) / (24 * 60 * 60 * 1000);
        return diffMillis;
    }
    
    public static double daysBetweenDouble(Date beforeDate, Date afterDate) throws FunctionalException {
        beforeDate = removeTime(beforeDate);
        afterDate = removeTime(afterDate);
    ...
    public static Date newStartDate(Date date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal.get(Calendar.DATE), 00, 00, 01);
        return cal.getTime();
    }
...
//    public static UserProfileImpl getUserProfileImpl(HttpServletRequest request) {
//        UserProfileImpl profile = (UserProfileImpl) request.getSession().getAttribute(UserProfile.SESSION_PROFILE);
//        return profile;
//    }
